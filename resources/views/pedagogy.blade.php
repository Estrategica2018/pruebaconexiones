    ...
    <div class="pr-lg-2 col-lg-12 mt-3">
        ...
        <div class="row mt-4">
            ...
            <div class="col-2-3  text-align">
                ...
                <div class="d-result d-none panel-icon-pedagogy-green fs--3" ng-show="icon_pedagogy==='scientific_experience'">
					<div style="margin-left: 5vw;position: absolute;margin-top: -38px;">
            ...
            <div class="col-2-3  text-align">
				...
				<span class="justify-content-center font-weight-bold d-flex mt-1 ml-auto mr-auto w-75"> Ciencia Cotidiana </span>
				  <div class="d-result d-none panel-icon-pedagogy-blue fs--3 everyday_science_color" ng-show="icon_pedagogy==='everyday_science'">
					<div style="margin-left: 5vw;position: absolute;margin-top: -38px;">
            ...
            <div class="col-2-3 text-align">
                ...
                <div class="d-result d-none panel-icon-pedagogy-beige fs--3" ng-show="icon_pedagogy==='more_conextion'">
					<div style="margin-left: 5vw;position: absolute;margin-top: -38px;">
