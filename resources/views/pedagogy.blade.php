...
<div class="container" style="min-width:661px;"  ng-controller="pedagogyCtrl" ng-init="init()">
    ...
    <div class="background-sequence-card mt-3 ml-3 row d-none-result" w="1519" h="4024">
    ...
    <div class="col-12 mt-3" fs="30">
        ...
        <div class="row mt-4">
            ...
            <div class="col-2-3  text-align">
				...
				<span class="font-14px justify-content-center font-weight-bold d-flex mt-1 ml-auto mr-auto w-75"> Pregunta Central </span>
                <div class="d-none-result d-none panel-icon-pedagogy fs--3 mt-3" ng-show="icon_pedagogy==='central_question'">
            ...
            <div class="col-2-3  text-align">
				...
				<span class="font-14px justify-content-center font-weight-bold d-flex mt-1 ml-auto mr-auto w-75"> Experiencia Científica </span>
                <div class="d-none-result d-none panel-icon-pedagogy-green fs--3 mt-3" ng-show="icon_pedagogy==='scientific_experience'">
					<div style="margin-left: 5vw;position: absolute;margin-top: -38px;">
            ...
            <div class="col-2-3  text-align">
				...
				<span class="font-14px justify-content-center font-weight-bold d-flex mt-1 ml-auto mr-auto w-75"> Ciencia Cotidiana </span>
				  <div class="d-none-result d-none panel-icon-pedagogy-blue fs--3 mt-3 everyday_science_color" ng-show="icon_pedagogy==='everyday_science'">
					<div style="margin-left: 5vw;position: absolute;margin-top: -38px;">
            ...
            <div class="col-2-3 text-align">
                ...
                <span class="font-14px justify-content-center font-weight-bold d-flex mt-1 ml-auto mr-auto w-75"> + Conexiones </span>
                <div class="d-none-result d-none panel-icon-pedagogy-beige fs--3 mt-3" ng-show="icon_pedagogy==='more_conextion'">
					<div style="margin-left: 5vw;position: absolute;margin-top: -38px;">
