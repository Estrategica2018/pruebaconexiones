                                  ...
                                  @foreach($elements as $element)
                                    ...
                                    <div ml="{{$element['ml']}}" mt="{{$element['mt']}}">
                                        <div id="{{$element['id']}}" class="{{$element['class']}} evidence-head cursor-pointer" 
                                           ...
                                           ng-click="onClickEvidence('{{$sequence_id}}','{{$moment->id}}','{{$element['id']}}','@if(isset($element['icon'])){{$element['icon']}}@endif','@if(isset($element['subtitle'])){{$element['subtitle']}}@endif','{{$part_id}}')">
