                        ...
                        <div class="col-12 row p-3">
                            <div class="col-12 row border-1000 border-bottom p-0">
                                ...
                                <div class="col-3 p-0 fs-0">  
                                    @if(isset($rating['weighted'] ))
                                        <label class=""><strong>Desempeño</strong></label>                                     
                                        @if($rating['weighted']>=90)
                                        <i class="fa fa-circle mr-2" style="color:#6CB249" aria-hidden="true"></i> (S) {{$rating['weighted']}} %
                                        @endif
                                        @if($rating['weighted']>=70 && $rating['weighted']<=89)
                                        <i class="fa fa-circle  mr-2" style="color:#6CB249" aria-hidden="true"></i> (A) {{$rating['weighted']}} %
                                        @endif
                                        @if($rating['weighted']>=60 && $rating['weighted']<=69)
                                        <i class="fa fa-circle mr-2" style="color:#F9E538" aria-hidden="true"></i> (B) {{$rating['weighted']}} %
                                        @endif
                                        @if($rating['weighted']>=40 && $rating['weighted']<=59)
                                        <i class="fa fa-circle mr-2" style="color:#AC312A" aria-hidden="true"></i> (B) {{$rating['weighted']}} %
                                        @endif
                                        @if($rating['weighted']> 0  && $rating['weighted']<40)
                                        <i class="fa fa-circle mr-2" style="color:#AC312A" aria-hidden="true"></i> (B) {{$rating['weighted']}} %
                                        @endif
                                        @if($rating['weighted']==0)
