...
<div class="min-vh-100 py-6 ml-auto mr-auto">
   <div class="col-12 ml-auto mr-auto">
      <div class="text-center card">
         <div class="p-5 card-body">
            <div class="display-1 text-200 fs-error">404</div>
            <p class="lead mt-4 text-800 text-sans-serif font-weight-semi-bold">@if($message) {{$message}} @else {{'Error cargando la página'}} @endif</p>
            <hr>
            <p>No se encuentra la página</p>
            <a class="btn btn-primary btn-sm mt-3" href="{{route('home')}}">
